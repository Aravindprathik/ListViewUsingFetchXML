...
> {
  ...
  private _onChangeText = (
    ...
    this.setState({
      items: newValue
        ? this.searchDocuments(this._allItems, newValue)
        : this._allItems,
    });
  };
  ...
  private searchDocuments = (
    ...
    return documents.filter((document) =>
      this.documentMatchesFilter(document, normalizedFilterText)
    );
  };
  ...
  private documentMatchesFilter = (
    ...
    return Object.values(document).some((value) =>
      this.valueMatchesFilter(value, filterText)
    );
  };

  private valueMatchesFilter = (value: any, filterText: string): boolean => {
